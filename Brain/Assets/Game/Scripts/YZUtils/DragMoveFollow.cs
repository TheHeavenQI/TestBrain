...
/// </summary>
/// 
public class DragMoveFollow : EventCallBack
{
    public RectTransform mFollowObj;
    ...
    Vector3 followObjDisVec;
    private void Awake()
    {
        base.Awake();
        _rectTransform = transform as RectTransform;
        if (mFollowObj != null)
            followObjDisVec = mFollowObj.localPosition - transform.localPosition;
    ...
    private void Start()
    {
        ...
        onDragDraging = (a) => {
            if (enabelDrag)
            {
                ...
                if (mFollowObj != null)
                    mFollowObj.localPosition = transform.localPosition + followObjDisVec;
                onDrag?.Invoke();
            }
        };
    }
