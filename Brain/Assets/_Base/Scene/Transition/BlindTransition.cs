...
namespace BaseFramework
{
    public class BlindTransition : TransitionBase, ISingleton
    {
        ...
        public static BlindTransition instance => SingletonHandler.instance;
        ...
        public override void Enter()
        {
            ...
            for (int i = 0; i < num; ++i)
            {
                ...
                tweener.Insert(i * 0.02f,
                               cellList[i].rectTransform.DOLocalRotate(Vector3.zero, 0.5f, RotateMode.FastBeyond360));
            }
        ...
        public override void Exit()
        {
            ...
            for (int i = num - 1; i >= 0; i--)
            {
                ...
                tweener.Insert(num2 * 0.02f,
                               cellList[i].rectTransform
                                          .DOLocalRotate(Vector3.up * 90f, 0.5f, RotateMode.FastBeyond360));
                num2++;
            }
