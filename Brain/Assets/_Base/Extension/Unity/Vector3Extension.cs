...
namespace BaseFramework
{
    public static class Vector3Extension
    {
        ...
        {
            _cacheV3.x = Mathf.Clamp(self.x, min.x, max.x);
            _cacheV3.y = Mathf.Clamp(self.y, min.y, max.y);
            _cacheV3.z = Mathf.Clamp(self.z, min.z, max.z);
            return _cacheV3;
        }
        ...
        {
            return Physics.Raycast(self, direction, out RaycastHit hit, maxDistance, layerMask) ? hit.transform : null;
        }
